 ...
 *
 * Mirrors the CrossLedger AI Organism, adapted to the GDN-AI-Gideon static site.
 * Uses the .cjs extension so it loads as CommonJS even though package.json
 * sets "type": "module". Applies SEO/copy patches directly to the live
 * homepage (gdn-ai-trial.html) and refreshes public/sitemap.xml.
 */
